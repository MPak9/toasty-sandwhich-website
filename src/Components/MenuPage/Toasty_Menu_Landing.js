...
const Toasty_Menu_Landing = () => {
  return (
    <div className='menu_landing_grid'>
        ...
        <div style={{ gridRow: '2 / span 2', gridColumn: '2 / span 3', display:'flex', justifyContent:'center'}}>
            <h2 style={{alignSelf:'center'}}>
                Sandwich of the Month
            </h2>
        </div>
        <div style={{gridRow: '4/span2', gridColumn: '3 / span 2', display:'flex', justifyContent:'center', transform: 'rotate(-10deg)'}}>
        ...
        <div style={{display:'flex', gridRow: '3/ span 4', gridColumn: '2/ span 3', zIndex:'-2', justifyContent:'center'}}>
        ...
        <div style={{ gridRow: '3/ span 4', gridColumn: '2 / span 3', zIndex:'1', display:'flex', justifyContent:'center', zIndex:'-3'}}>
        ...
        <div style={{ gridRow: '2 / span 5', gridColumn: '5', display:'flex'}}>
